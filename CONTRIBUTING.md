...
1. Fork the repo, then clone the parent repo or set your local `origin` back to the parent repo (`git@github.com:knowttl/atelier-axi.git`).
2. Create a branch and make your changes.
3. Initialize or refresh the gate with your fork as the push target: `no-mistakes init --fork-url git@github.com:<you>/atelier-axi.git`.
...
- User-facing telemetry docs should stay minimal: anonymous usage telemetry, no sensitive content, and `ATELIER_AXI_TELEMETRY=0` opt-out.
