...
function Brand() {
  return (
    <div style={mc.brand}>
      <span style={mc.brandMark}>Atelier</span>
...
function ArtifactBody({ note }) {
  return (
    <div style={mc.artifact}>
      ...
      <p style={mc.artLede}>Atelier opens an agent-generated HTML artifact in a local browser, lets you pinpoint elements, and ships your feedback back to the agent.</p>
      {note}
    </div>
  );
}
