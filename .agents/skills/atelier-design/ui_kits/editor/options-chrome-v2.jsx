...
function Brand() {
  return <div style={v2.brand}><span style={v2.brandMark}>Atelier</span><span style={v2.brandSupport}>Editor</span></div>;
}
...
function ArtifactBody() {
  return (
    <div style={v2.artifact}>
      ...
      <p style={v2.artLede}>Atelier opens an agent-generated HTML artifact in a local browser, lets you pinpoint elements, and ships your feedback back to the agent.</p>
    </div>
  );
}
