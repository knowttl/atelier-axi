...
Atelier Editor is a CLI + local HTTP server that opens agent-generated HTML artifacts in a browser, lets the user annotate elements, selected text ranges, or Mermaid diagram nodes, and ships those annotations back to the agent over a long-polling API.
