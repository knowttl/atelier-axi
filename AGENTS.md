...
Atelier Editor is a CLI + local HTTP server that opens agent-generated HTML artifacts in a browser, lets the user annotate elements or selected text ranges, and ships those annotations back to the agent over a long-polling API.
