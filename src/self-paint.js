...
// over whatever surface hosts it (the Atelier chrome, a shared page, a captain's light
...
export const SELF_PAINT_WARNING =
  "This artifact never paints its own page surface: no background on html/body/:root, no bg-* class or data-theme on html/body, and no stylesheet that could set one. Atelier injects no design system, so text that assumes a dark or light host surface can render invisible. Set an explicit background and readable text.";
