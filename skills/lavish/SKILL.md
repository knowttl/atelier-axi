...
- To plan a feature or change before building it, run `npx -y lavish-axi playbook plan`: surface the open questions and edge cases as a visual review surface first, converge with the user, then produce a spec and a bite-sized implementation plan.
